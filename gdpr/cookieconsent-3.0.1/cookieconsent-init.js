...
window.addEventListener("load", function () {
  ...
  // In v3+, the global object is CookieConsent—not initCookieConsent.
  var cc = CookieConsent;

  // Run the library with your configuration.
  cc.run({
    current_lang: 'en',
    ...
    // revision: 0,             // increment this to force re-consent
    ...
    onChange: function (cookie, changed_preferences) {
      // Called when a user changes their preferences in the settings modal.
    },
